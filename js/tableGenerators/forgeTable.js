...
export function generateForgeTable(containerId, FORGE_FORMULAS, generateTableHTML, createItemNameMap, itemBase) {
    ...
    const data = Object.keys(FORGE_FORMULAS).map(id => {
        ...
        const hidden = formula.hidden ? i18n.translate('yes') : '';
        const onlySmelt = formula.only_smelt ? i18n.translate('yes') : '';
        const recycle_chance = formula.recycle_chance ? formula.recycle_chance : '';
